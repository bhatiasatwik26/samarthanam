                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        ...
                        <div className="flex items-center text-slate-600 dark:text-slate-300">
                          ...
                          <span>
                            {event.location.includes("Karnataka")
                              ? event.location
                              : "Bengaluru, Karnataka"}
                          </span>
                        </div>
        ...
        <div className="container mx-auto px-6">
          ...
          {displayedEvents.length > 6 && (
            <div className="text-center mt-12">
              <Button
                variant="outline"
                className="mx-auto border-red-200 text-red-600 hover:bg-red-100 dark:border-red-800 dark:text-red-400 dark:hover:bg-red-800/30"
              >
                Load more events
              </Button>
            </div>
