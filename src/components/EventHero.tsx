      ...
      <div className="container mx-auto px-6 md:px-12 pt-20 z-10 relative">
        <div className="max-w-3xl">
          <div className={cn(
            ...
            <span className="inline-block py-1 px-3 rounded-full bg-red-600/10 text-red-200 text-sm font-medium backdrop-blur-sm border border-red-500/20 mb-4" aria-label="Samarthanam NGO">
              Samarthanam NGO
            </span>
          </div>
